...
ALTER TABLE instructor CHANGE fechaIncorporación fechaIncorporacion DATE;
...
DELETE FROM cohorte WHERE idCohorte = 1247;
...
VALUES (10,'19507661','Hillary','Holman','2001-04-07','2019-12-14',1235),
  ...
  (19,'435719201','Lillith','Conley','0000-01-01','2019-12-11',1235),
